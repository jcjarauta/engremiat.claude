...
const EXPECTED_MODULE_COUNTS = { CORE: 60, GANTT: 3, ECONOMICO: 1, IMPACTO: 1, COMPRAS: 6, CONVOCATORIAS: 2, CLIENTE: 3, VENTAS: 3, OPORTUNIDAD: 2 };
...
export function validatePackageMap(map) {
  ...
  const expectedCounts = { production: 81, test: 8, auxiliary: 38, excluded: 28, mixed: 0 };
