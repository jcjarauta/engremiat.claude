...
const EXPECTED_MODULE_COUNTS = { CORE: 82, GANTT: 3, ECONOMICO: 1, IMPACTO: 2, COMPRAS: 7, CONVOCATORIAS: 2, CLIENTE: 4, VENTAS: 3, OPORTUNIDAD: 2, OPERATIVA: 3, SEGUIMIENTO: 0, EJECUCION: 0, ESCENARIOS: 0, APROVISIONAMIENTO: 5, COMUNICACION: 1 };
...
export function validatePackageMap(map) {
  ...
  const expectedCounts = { production: 115, test: 11, auxiliary: 35, excluded: 52, mixed: 0 };
