...
- Paso 7 del roadmap (Fase H, UI) en curso: bug crítico de serialización de fechas encontrado y corregido en Panel operativo e Informes (`src/SerializacionService.js` nuevo), más reescritura de la exportación CSV/PDF (`aplanarInformeParaExportar_`). Verificado visualmente por el usuario en Apps Script real.
